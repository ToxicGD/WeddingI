...
<footer class="my-4  text-muted text-center">
    ...
    <p class="text-dark">&copy; 2024 Toxic. All rights reserved.</p>
    <ul class="list-unstyled d-flex">
        <li class="ms-3"><a class="link-dark" href="https://twitter.com/Daimer_Quinter0"><i class="bi bi-twitter sizeI"></i></a></li>
